...
<jsp:useBean id="checkPassword" class="com.inetvod.webapp.PasswordService" scope="request"/>
...
<%			
	...
	if(!str_Quest_Ans[1].equals(checkPassword.getInstance().encrypt(str_Answer)))
...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="760">
    <tr>
      ...
      <td valign="top" class="contentWithoutBorder"><form action="mem_reset_password_save.jsp" method="post" name="inet">
          ...
          <table border="0" cellpadding="1" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="520" id="tbl_Register" >
            ...
            <tr>
              <td width="170" align="right" valign="top"><font size="2"><span class="contentRed">*</span>New Password</font></td>
              <td width="366" align="left" valign="top"><font size="2" face="Verdana"> &nbsp;
            ...
            <tr>
              ...
              <td valign="baseline"><input type="button" value="Cancel" name="btn_Cancel"  onClick="javascript:location.href='mem_logon.jsp'"  />
				&nbsp;&nbsp;
				<input type="submit" id="btn_Continue" value="Save" name="btn_Continue" onClick="return Call_Validator()" /></td>
            </tr>
          </table>
      </form>
  </td></tr></table>
