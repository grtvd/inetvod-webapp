...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="760">
    <tr>
      ...
      <td valign="top" class="contentWithoutBorder"><form action="#" method="post" name="inet">
          <noscript>
          <h1><font color="#FF0000">Your browser does not support JavaScript! Please enabale Javascript and try again...</font></h1>
          </noscript>
          <table border="0" cellpadding="1" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="tbl_Register"  >
            <tr valign="top">
              <td><h2>Error</h2></td>
            </tr>
            <tr valign="top">
            ...
            <tr>
              <td valign="baseline"><input type="button" value="Logon" onClick="location.href='mem_logon.jsp'" name="btn_Cancel" /></td>
            </tr>
          </table>
      </form>
  </td></tr></table>
