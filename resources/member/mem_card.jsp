...
<% 
	...
	String [][] cardList = readXML.readXML("Card_Type");
...
function Call_Validator()
{
	...
	{
		if (
				CheckForBlank(document.getElementById("tbx_Card_Name"), document.getElementById("err_Card_Name"), "Name on Card is a required field and must be entered ") == false ||
				CheckForLength(document.getElementById("tbx_Card_Name"), 64, document.getElementById("err_Card_Name"), "Name on Card character length should be less then 64") == false ||			
				CheckForCombo(document.getElementById("cmb_Card_Type"), document.getElementById("err_Card_Type"), "Card Type is a required field and must be selected ") == false ||								
				CheckForBlank(document.getElementById("tbx_Card_Number"), document.getElementById("err_Card_Number"), "Card Number is a required field and must be entered ") == false ||				
				CheckForCombo(document.getElementById("cmb_Month"), document.getElementById("err_Month"), "Expiry Month is a required field and must be selected ") == false ||				
				CheckForCombo(document.getElementById("cmb_Year"), document.getElementById("err_Year"), "Expiry Year is a required field and must be selected ") == false ||												
				CheckForBlank(document.getElementById("tbx_Code"), document.getElementById("err_Code"), "Security Code is a required field and must be entered ") == false ||	
				CheckForBlank(document.getElementById("tbx_Add_1"), document.getElementById("err_Add_1"), "Address Line 1 is a required field and must be entered ") == false ||	
				//CheckForBlank(document.getElementById("tbx_Add_2"), document.getElementById("err_Add_2"), "Address Line 2 is a required field and must be entered ") == false ||	
				CheckForBlank(document.getElementById("tbx_City"), document.getElementById("err_City"), "City is a required field and must be entered ") == false ||	
				CheckForBlank(document.getElementById("tbx_State"), document.getElementById("err_State"), "State / Providence is a required field and must be entered ") == false ||	
				CheckForBlank(document.getElementById("tbx_Zip"), document.getElementById("err_Zip"), "Zip / Postal Code is a required field and must be entered ") == false ||													
				CheckForCombo(document.getElementById("cmb_Country"), document.getElementById("err_Country"), "Country is a required field and must be selected ") == false ||												
				CheckForBlank(document.getElementById("tbx_Phone"), document.getElementById("err_Phone"), "Phone is a required field and must be entered ") == false														
			)
		{
			validated = false;
...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="760">
    <tr>
      <td align="left" valign="top" class="leftside" width="222"><jsp:include flush="true" page="../includes/left_navigation.jsp?page=other&link=card"/>  
      </td>
      <td valign="top" class="contentWithoutBorder"><form action="mem_card_save.jsp" method="post" name="inet">
          <noscript>
          ...
          <table border="0" cellpadding="1" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="520" id="tbl_Register" >
            ...
            <tr valign="top">
              <td align="right" >&nbsp;</td>
              <td width="403" align="left"><div id="err_General" style="display:none" class="contentRed"></div></td>
            </tr>
            <tr valign="top">
              <td width="133" align="right" ><font size="2">Name on Card </font></td>
              <td align="left">&nbsp;
                  <input type="text" id="tbx_Card_Name" name="tbx_Card_Name" size="40" maxlength="64" value="<%= newMember.Check_For_Null(newMember.getName_on_card()) %>" />
                  <div id="err_Card_Name" style="display:none" class="contentRed"></div>			  </td>
            </tr>
            <tr>
              <td width="133" align="right"><font size="2">Card Type </font></td>
...
%>					
				...
				<div id="err_Card_Type" style="display:none" class="contentRed"></div>
              </font></td>
            </tr>
            <tr>
              <td align="right"><font size="2">Card Number </font></td>
              <td align="left"><font size="2" face="Verdana"> &nbsp;
                    <input type="text" id="tbx_Card_Number" name="tbx_Card_Number" size="32" maxlength="32"  value="<%= newMember.Check_For_Null(newMember.getCard_number())%>"  onKeyPress="IntIEKeyCap()" />
                    <div id="err_Card_Number" style="display:none" class="contentRed"></div>
              </font></td>
            </tr>
            <tr>
              <td align="right"><font size="2">Expiration Date </font></td>
              <td align="left"><font size="2" face="Verdana"> &nbsp;
				...
				<div id="err_Month" style="display:none" class="contentRed"></div>
				<div id="err_Year" style="display:none" class="contentRed"></div>
              </font></td>
            </tr>
            <tr>
              <td align="right"><font size="2">Security Code </font></td>
              <td align="left"><font size="2" face="Verdana"> &nbsp;
                    <input type="text" id="tbx_Code" name="tbx_Code" size="4" maxlength="4"  value="<%= newMember.Check_For_Null(newMember.getSecurity_code())%>"  onKeyPress="IntIEKeyCap()" />
					<div id="err_Code" style="display:none" class="contentRed"></div>
              </font></td>
            </tr>
            <tr>
              <td align="right">&nbsp;</td>
            ...
            <tr>
              <td width="133" align="right" valign="top"><font size="2">Address Line</font></td>
            ...
            <!--tr>
              <td width="25%" align="right"><font size="2">Address Line 2 </font></td>
              <td align="left"><font size="2" face="Verdana"> &nbsp;
...
%>					
            ...
            <tr>
              ...
              <td align="left"><font size="2" face="Verdana">&nbsp;
                    <input type="text" id="tbx_Phone" name="tbx_Phone" size="32" maxlength="32"  value="<%= newMember.Check_For_Null(newMember.getPhone())%>"  />
                    <div id="err_Phone" style="display:none" class="contentRed"></div>
                    </font>
              <br /><font size="1" face="Verdana">&nbsp;&nbsp;used to verify your credit card </font></td>
            </tr>
            <tr>
